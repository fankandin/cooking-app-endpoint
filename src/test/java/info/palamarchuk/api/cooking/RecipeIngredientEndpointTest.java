...
public class RecipeIngredientEndpointTest {
    ...
    public void shouldGetById() throws Exception {
        ...
        given(recipeIngredientService.getById(data.id)).willReturn(Optional.of(recipeIngredient));
    ...
    public void shouldPatch() throws Exception {
        ...
        given(recipeIngredientService.getById(recipeIngredient.getId()))
            .willReturn(Optional.of(recipeIngredient));
    ...
    public void shouldFilterIgnoredPatchFields() throws Exception {
        ...
        given(recipeIngredientService.getById(recipeIngredient.getId())).willReturn(Optional.of(recipeIngredient));
