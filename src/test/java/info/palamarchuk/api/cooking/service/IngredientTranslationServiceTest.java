...
public class IngredientTranslationServiceTest {
    ...
    public void shouldFindById() throws Exception {
        var translation = service.getById(storedTranslations[0].getId()).get();
        new Verifier(storedTranslations[0]).verify(translation);
        assertThat(translation.getId(), is(storedTranslations[0].getId()));

        translation = service.getById(storedTranslations[1].getId()).get();
    ...
    public void shouldUpdate() throws Exception {
        ...
        testingHelper.assertUpdating(service, service.getById(3L).get(), verifier);
    }
