...
public class IngredientServiceTest {
    ...
    public void shouldUpdate() {
        testingHelper.assertUpdating(service, service.getById(1L).get(), new Verifier("red onion"));
    }
